 ...
 */
final class Version20250820184437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE roles (id INT AUTO_INCREMENT NOT NULL, user_uuid UUID NOT NULL COMMENT \'(DC2Type:uuid)\', role VARCHAR(255) NOT NULL, INDEX IDX_B63E2EC7ABFE1C6F (user_uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE roles ADD CONSTRAINT FK_B63E2EC7ABFE1C6F FOREIGN KEY (user_uuid) REFERENCES users (uuid)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE roles DROP FOREIGN KEY FK_B63E2EC7ABFE1C6F');
